...
public class GenApiFinal {
  public void apiGetCar() {
    try {
      post("/getInfoCar", (request, response)->  {
        MongoClient mongoClient = getMongoClient();
        DB db = mongoClient.getDB("api_test");
        DBCollection peopleCol = db.getCollection("Car");
  ...
  public void apiInsertCar() {
    try {
      post("/insertInfoCar", (request, response)->  {
        try {
          MongoClient mongoClient = getMongoClient();
          DB db = mongoClient.getDB("api_test");
          DBCollection peopleCol = db.getCollection("Car");
  ...
  public void apiUpdateCar() {
    try {
      post("/updateInfoCar", (request, response)->  {
        try {
          MongoClient mongoClient = getMongoClient();
          DB db = mongoClient.getDB("api_test");
          DBCollection peopleCol = db.getCollection("Car");
  ...
  public void apiDeleteCar() {
    try {
      post("/deleteInfoCar", (request, response)->  {
        try {
          MongoClient mongoClient = getMongoClient();
          DB db = mongoClient.getDB("api_test");
          DBCollection peopleCol = db.getCollection("Car");
  ...
  public static void main(String[] args) {
    new GenApiFinal().apiDeleteCar();
                new GenApiFinal().apiGetCar();
                new GenApiFinal().apiInsertCar();
                new GenApiFinal().apiUpdateCar();;
  }
}
